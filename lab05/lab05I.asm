...
.data
  ...
  ; n! == 44! == ^54 <= 192 bits (6*32)
  ; (n!)^2 = (44!)^2 == ^108 <= 384 bits (12*32)

  ; EQUs FOR SIZE
  FactorialNGroupsOf32 equ 6 ; amount of groups of 32 bits
  FactorialNSqrGroupsOf32 equ 12 ; amount of groups of 32 bits
